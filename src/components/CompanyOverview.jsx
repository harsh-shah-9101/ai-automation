            ...
            <div className="container">
                <div className="glass-card fade-in-up">
                    ...
                    <p className="overview-text">
                        Flowbotic AI is a next-generation AI solutions and automation agency that helps businesses harness the power of artificial intelligence to accelerate growth, streamline operations, and deliver superior customer experiences.
                    </p>
                    <p className="overview-text">
